--มึงอย่า Reskin ดิ๊ทําไมไม่obfเพราะobfแล้วหน่วงบางฟังชั้นขึ้นไม่ครบคนทีใช้scrกูSkidหมด!!
...
function Update:Window(text,logo,keybind)
    ...
    MapName.Text = "         | Blox Fruits        v1 [BETA]"
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(16053605732)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(16053605732)
...
spawn(function()
    ...
    spawn(function()
        pcall(function()
            while wait() do
                if _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFactory or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongSword or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.TeleportIsland or _G.Auto_EvoRace or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or _G.AutoBudySword or _G.AutoOderSword or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or FarmBoss or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.AutoFarmMaterial or _G.AutoNevaSoulGuitar or _G.Auto_Dragon_Trident or _G.Autotushita or _G.d or _G.Autowaden or _G.Autogay or _G.Autopole or _G.Autosaw or _G.AutoObservationHakiV2 or _G.AutoFarmNearest or AutoFarmChest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.Tweenfruit or _G.TeleportNPC or _G.Leather or _G.Auto_Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or Gunpowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoMysticIsland or _G.AutoFarmDungeon or _G.AutoRaidPirate or _G.AutoQuestRace or _G.TweenMGear or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or Grab_Chest or _G.Namfon or _G.AutoSwordMastery or _G.Auto_Seabest or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Position_Spawn or _G.Farmfast or _G.AutoRace or _G.RaidPirate or _G.AutoTushitaSword or Open_Color_Haki or _G.AutoTerrorshark or FarmShark or _G.farmpiranya or _G.Fish_Crew_Member or _G.DomadicAutoDriveBoat or _G.bjirFishBoat or _G.KillGhostShip or _G.AutoWooddenPlank or _G.EnableDriveDoMaD == true then
...
local Library = Update:Window("    Finn","16053605732",Enum.KeyCode.RightControl);

local H = Library:AddTab("Inicio","6026568198")
local Main = Library:AddTab("Auto Farm","13075651575")
local M = Library:AddTab("Item Quest","13075622619")
local Ss = Library:AddTab("Status","7040410130")
local RaceV4 = Library:AddTab("Raça V4","11162889532")
local P = Library:AddTab("Players","7251993295")
local R = Library:AddTab("Auto Raid","11155986081")
local T = Library:AddTab("Teleport","11155851001")
local S = Library:AddTab("Loja","6031265976")
local D = Library:AddTab("Frutas","7044233235")
local Misc = Library:AddTab("Esp e Outros","11156061121")
...
H:AddLabel("Seja Bem Vindo Ao Finn Hub!!")
H:AddLabel("Nosso Script Tem Suporte Para Pc e Mobile")

H:AddSeperator("Creditos")



H:AddButton("Criado por Skinny Gb Juju",function()
setclipboard("..")
end)

H:AddLine()
H:AddLabel("New Update Log")
H:AddLabel("[+] Auto Set Frame Mon")
H:AddLabel("[+] Esp Kitsune Island")
H:AddLabel("[+] Send Notifications Kisune Spawn")


H:AddSeperator("UpdLog")


H:AddLabel("[+] Reduzido Tween Speed")
H:AddLabel("[+] Adicionado Super Fast Attack")
H:AddLabel("[+] Adicionado Anti Afk")
...
Main:AddToggle("Auto SetSpawn Point [Use isso com o Bypass TP]",true,function(value)
    _G.Set = value
end)
...
Main:AddToggle("Auto Farm All",false,function(value)
       _G.AutoFarm = value
...
Main:AddToggle("Auto Chest Stop Calice",_G.STP,function(vu)
	Grab_Chest = vu
...
Main:AddToggle("Bypass Tp",BypassTP,function(Fast)
BypassTP = Fast
end)
...
spawn(function()
    ...
    Main:AddToggle("Fast Attack Super Fast [Ative o Fast Attack!] ",_G.NotDeley,function(value)
        _G.NotDeley = value
    end)      
...
elseif _G.WhiteScreen == false then
    ...
    Mirragecheck:Set('🏝️: Mirage Island is Spawning')
      ...
      Mirragecheck:Set('❌: Mirage Island Not Spawn ' )end
            end
        end)
end)
Mirragecheck = M:AddLabel("")
M:AddToggle("Auto Mirage Island",_G.AutoMysticIsland,function(value)
...
M:AddButton("Função Acima Ativada Click Aqui", function()
                TweenNpc()
                end)
...
M:AddToggle("Teleportar na Engrenagem",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
spawn(function()
    ...
    M:AddSeperator("Estilos de Luta")
...
spawn(function()
   ...
   M:AddSeperator("Auto Maestria")
    
    M:AddToggle("Auto Farm BF Maestria",_G.AutoFarmFruitMastery,function(value)
    ...
    M:AddToggle("Auto Farm Gun Maestria",_G.AutoFarmGunMastery,function(value)
...
function EquipWeaponSword()
    ...
    M:AddToggle("Auto Farm Sword Maestria",_G.AutoSwordMastery,function(value)
    ...
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsunen Island') then
                FaiFaoKai:Set('🦊: Kitsune Island Spawn')
            else
                FaiFaoKai:Set('🔴: Kitsune Island Not Spawn')
            end
        end
    end)
end)
...
M:AddToggle('Ativar Hop Sea Event Farm', false, function(value)
...
ColorHaki = M:AddLabel("HuaiPaDang")
    ...
    M:AddToggle("Auto Raça V2",_G.Auto_EvoRace,function(value)
...
spawn(function()
    ...
    if World1 or World2 then
RaceV4:AddLabel("Vá Para o Sea 3 Porra")
end
...
RaceV4:AddToggle("Auto Ancient One Quest [Farm Raça V4]",_G.AutoRace,function(value)
 _G.AutoRace = value
 StardFarm = value
...
RaceV4:AddToggle("Disabled Inf Stairs", nil, function(value)
  ...
  RaceV4:AddButton("Teleport Cyborg Door (Esteja no Templo do Templo)",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
  RaceV4:AddButton("Teleport Fish Door (Esteja no Templo do Templo)",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  RaceV4:AddButton("Teleport Ghoul Door (Esteja no Templo do Templo)",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  RaceV4:AddButton("Teleport Human Door (Esteja no Templo do Templo)",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  RaceV4:AddButton("Teleport Mink Door (Esteja no Templo do Templo)",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  RaceV4:AddButton("Teleport Sky Door (Esteja no Templo do Templo)",function()
  ...
  RaceV4:AddToggle("Auto Kill Player in Trail [Beta]",false,function(Val)
  _G.AutoKillTial = Val
  StopTween(_G.AutoKillTial)
  end)
  RaceV4:AddToggle("Auto Treino Raça V4",false,function(v)
  _G.AutoQuestRace = v
...
P:AddButton("Set Position Spawn",function()
    ...
    local Island1 = R:AddLabel(": llha 1")
    local Island2 = R:AddLabel(": llha 2")
    local Island3 = R:AddLabel(": llha 3")
    local Island4 = R:AddLabel(": llha 4")
    local Island5 = R:AddLabel(": llha 5")
